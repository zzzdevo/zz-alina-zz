...
async def init():
    ...
    await Mukesh.start()
    try:
        await Mukesh.stream_decall("https://te.legra.ph/file/6638503823c2a97047e47.mp4")
    except:
        pass
    try:
